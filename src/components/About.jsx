    ...
    <section className="about" id="about">
      <div className="container">
        <div className="section-header">
          <div className="section-label"><i className="fas fa-user" /> About Me</div>
        ...
        <div className="about-grid">
          <div ref={r1} className="about-text reveal">
            ...
            <p>
              I'm a Full Stack Developer and AI & Machine Learning student passionate about building modern web applications. I specialize in creating responsive user experiences that combine clean design with practical development and intelligent AI-powered solutions.</p>
            <p>
          ...
          <div ref={r2} className="about-visual reveal reveal-delay-1">
            <div className="about-visual-frame">
              <img src="/profile.jpeg" alt="About" />
              <div className="about-visual-badge">
                <div className="about-badge-inner">
                  <div className="about-badge-avatar">VS</div>
                  <div>
                  ...
                  <div className="about-badge-status">
                    <span className="about-badge-dot" /> Open to Work
                  </div>
                </div>
              </div>
            </div>
