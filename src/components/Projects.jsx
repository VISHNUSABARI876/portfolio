...
const projects = [
  {
    ...
    imgAlt: 'AI Assistant project preview',
  ...
  },
  {
    ...
    imgAlt: 'AI Detection project preview',
    ...
    <section className="projects" id="projects">
      <div className="container">
        <div ref={r0} className="section-header reveal">
          <div className="section-label"><i className="fas fa-folder-open" aria-hidden="true" /> Featured Work</div>
    ...
    <div ref={ref} className={`project-card reveal ${delay}`}>
      ...
      <div className="project-content">
        <span className="project-status live">
          <i className="fas fa-circle" style={{ fontSize: '0.4rem' }} aria-hidden="true" /> {demo ? 'Live' : 'Alpha'}
        </span>
